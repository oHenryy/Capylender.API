...
namespace Capylender.API.Migrations
{
    ...
    [Migration("20250529020025_SeedAdminUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Capylender.API.Models.FeedbackAgendamento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FeedbacksAgendamento");
                });
            ...
            modelBuilder.Entity("Capylender.API.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Nome = "Administrador",
                            Role = "Admin",
                            SenhaHash = "$2a$11$adlkUYw1ZZB17CC6tqWXEuqaK4QWewvsYe8ZI3fiRwG.QjaM3QzEm"
                        });
                });
            ...
            modelBuilder.Entity("Capylender.API.Models.FeedbackAgendamento", b =>
                {
                    b.HasOne("Capylender.API.Models.Agendamento", "Agendamento")
                        .WithMany()
